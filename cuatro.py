...
while (x!=3):
    ...
    if(x==1):
        ...
        ingredientes.append(input("Ingrese de que ingrediente 1 "))
        ingredientes.append(input("Ingrese de que ingrediente 2 "))
        ingredientes.append(input("Ingrese de que ingrediente 3 "))
